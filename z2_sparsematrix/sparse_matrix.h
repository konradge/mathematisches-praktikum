...
class Sparse_Matrix {
 ...
 public:
  ...
  Sparse_Matrix& operator+=(
      const Sparse_Matrix&);  // Zuweisungen mit arithm. Operation
  ...
  friend Sparse_Matrix operator+(const Sparse_Matrix&,
                                 const Sparse_Matrix&);  // Addition
  friend Sparse_Matrix operator-(const Sparse_Matrix&,
                                 const Sparse_Matrix&);  // Subtraktion
  ...
  friend Sparse_Matrix transpose(Sparse_Matrix& m);

  friend bool operator==(const Sparse_Matrix&,
                         const Sparse_Matrix&);  // Vergleich
  ...
  friend std::ostream& operator<<(std::ostream&,
                                  const Sparse_Matrix&);  // Ausgabe

  friend Vector operator*(const Sparse_Matrix&,
                          const Vector&);  // Sparse_Matrix-Vector-
  friend Vector operator*(const Vector&,
                          const Sparse_Matrix&);  // Multiplikation
};
